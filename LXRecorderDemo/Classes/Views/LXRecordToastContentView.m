...
@implementation LXRecordToastContentView


@end

@interface LXRecordingView ()

@property (nonatomic, strong) UIImageView *imgRecord;
@property (nonatomic, strong) UILabel *lbContent;
@property (nonatomic, strong) LXRecordPowerAnimationView *powerView;

@end

@implementation LXRecordingView
...
- (void)setUp
{
    ...
    self.powerView = [[LXRecordPowerAnimationView alloc] init];
...
@interface LXRecordReleaseToCancelView ()
@property (nonatomic, strong) UIImageView *imgRelease;
@property (nonatomic, strong) UILabel *lbContent;
@end

@implementation LXRecordReleaseToCancelView
...
@interface LXRecordCountingView ()
@property (nonatomic, strong) UILabel *lbContent;
@property (nonatomic, strong) UILabel *lbRemainTime;
@end

@implementation LXRecordCountingView
...
@interface LXRecordTipView ()
@property (nonatomic, strong) UIImageView *imgIcon;
@property (nonatomic, strong) UILabel *lbContent;
@end

@implementation LXRecordTipView
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
