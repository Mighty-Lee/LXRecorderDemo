...
#define LXSecretTrainRecordFielName @"lvRecord.m4a"

@interface LXRecorderTool ()<AVAudioRecorderDelegate, AVAudioPlayerDelegate>
//录音文件地址
...
@implementation LXRecorderTool

static LXRecorderTool *instance = nil;
#pragma mark - 单例
...
- (AVAudioRecorder *)recorder {
    if (!_recorder) {
        ...
        NSString *filePath = [path stringByAppendingPathComponent:LXSecretTrainRecordFielName];
